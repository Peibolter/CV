...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Pablo Gonzalez
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">I'm creative software developer based in Spain, and I'm very passionate and dedicated to my work.
            </p>
